// Panda CMS JavaScript Bundle v0.9.0
// Compiled: 2025-11-04T16:43:57Z
...
// File Gallery Controller Controller
const FileGalleryControllerController = {
  connect() {
    console.log('[Panda CMS] File Gallery Controller controller connected');
  }
};

Stimulus.register('file-gallery-controller', FileGalleryControllerController);
...
const TreeControllerController = {
  connect() {
    console.log('[Panda CMS] Tree Controller controller connected');
  }
};

Stimulus.register('tree-controller', TreeControllerController);
...
(function() {
  ...
  try {
    console.log('[Panda CMS] Full JavaScript bundle v0.9.0 loaded');
    
    // Mark as loaded immediately to help with CI timing issues
    window.pandaCmsVersion = '0.9.0';
